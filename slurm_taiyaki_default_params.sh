...
time train_flipflop.py --full_filter_status --overwrite --device 0 --chunk_len_min 2000 --chunk_len_max 4000 --size 256 --stride 10 --winlen 31 --mod_factor 0.01 --outdir $out/default_training /biosw/taiyaki/5.0.1/models/mGru_cat_mod_flipflop.py $out/modbase.hdf5

echo "======== training2"

time train_flipflop.py --full_filter_status --overwrite --device 0 --chunk_len_min 2000 --chunk_len_max 4000 --size 256 --stride 10 --winlen 31 --mod_factor 0.1 --outdir $out/default_training2 $out/default_training/model_final.checkpoint $out/modbase.hdf5
